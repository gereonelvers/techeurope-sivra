      ...
      <div className="mx-auto grid max-w-6xl items-center gap-14 px-6 pb-20 pt-16 lg:grid-cols-[1fr_1.1fr] lg:pb-28 lg:pt-24">
        <div>
          ...
          <div className="mt-9 flex flex-wrap items-center gap-4">
            ...
            {/* Clean, image-free "Call Sivra" CTA — the photo lives in the
                closing panel (desktop) and the floating button (mobile). */}
            <a
              href="tel:+14472154920"
              className="group inline-flex items-center gap-2.5 rounded-full border border-ink/15 bg-white/60 px-4 py-2.5 transition hover:border-accent/40 hover:bg-white/80"
            >
              <span
                aria-hidden
                className="flex size-7 items-center justify-center rounded-full bg-accent/10 text-accent transition group-hover:bg-accent/20"
              >
              ...
              <span className="flex flex-col leading-tight">
                <span className="text-sm font-semibold text-ink/85 transition group-hover:text-accent">
                  Call Sivra
                </span>
